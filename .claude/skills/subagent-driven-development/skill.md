...
digraph process {
    ...
    "Use superpowers:multi-role-review" [shape=box style=filled fillcolor=lightyellow];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use superpowers:multi-role-review";
    "Use superpowers:multi-role-review" -> "Use superpowers:finishing-a-development-branch";
}
```
